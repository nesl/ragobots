 ...
 * This class implements a Java interface to the 'MoveMsg'
 * message type.
 */

public class MoveMsg extends net.tinyos.message.Message {

    /** The default size of this message type in bytes. */
    public static final int DEFAULT_MESSAGE_SIZE = 5;

    /** The Active Message type associated with this message. */
    public static final int AM_TYPE = 58;

    /** Create a new MoveMsg of size 5. */
    public MoveMsg() {
        super(DEFAULT_MESSAGE_SIZE);
        amTypeSet(AM_TYPE);
    }

    /** Create a new MoveMsg of the given data_length. */
    public MoveMsg(int data_length) {
        super(data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new MoveMsg with the given data_length
     * and base offset.
     */
    public MoveMsg(int data_length, int base_offset) {
        super(data_length, base_offset);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new MoveMsg using the given byte array
     * as backing store.
     */
    public MoveMsg(byte[] data) {
        super(data);
        amTypeSet(AM_TYPE);
    }
     ...
     */
    public MoveMsg(byte[] data, int base_offset) {
     ...
     */
    public MoveMsg(byte[] data, int base_offset, int data_length) {
        super(data, base_offset, data_length);
        amTypeSet(AM_TYPE);
    }

    /**
     * Create a new MoveMsg embedded in the given message
     * at the given base offset.
     */
    public MoveMsg(net.tinyos.message.Message msg, int base_offset) {
     ...
     */
    public MoveMsg(net.tinyos.message.Message msg, int base_offset, int data_length) {
